        ...
        <header className={`sticky top-0 z-10 ${surface} border-b ${border} px-6 py-4 flex items-center justify-between backdrop-blur-xl`}>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className={`text-xs ${muted}`}>Fevereiro 2025</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button className={`p-2 rounded-xl ${dark?"hover:bg-gray-800":"hover:bg-gray-100"} transition relative`}>
                ...
                <div className={`${surface} rounded-2xl border ${border} p-5`}>
                  ...
                  <ResponsiveContainer width="100%" height={170}>
                    <PieChart>
                      ...
                      <Tooltip formatter={(v)=>fmt(v)} contentStyle={{background:dark?"#1f2937":"#fff",border:`1px solid ${dark?"#374151":"#e5e7eb"}`,borderRadius:12,fontSize:12}}/>
                    </PieChart>
                  </ResponsiveContainer>
